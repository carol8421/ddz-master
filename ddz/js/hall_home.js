    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(response.code===0){
                ...
                $('.buttonList').append('<a href="'+cdkeyLink+'" class="cdkey"><img src="./images/hall/cdkey.png" alt=""></a><a class="yscq" style="cursor: pointer"><img src="./images/hall/mrlb.png" alt=""></a>');
                ...
                for(var i=0;i<40&&i<res.small_video.list.length;i++){
                    ...
                    if(i<4){
                        $('.swiper-svideo .swiper-wrapper').append('<div class="swiper-slide">' + myHTML.itemHTML(opt,1) + '</div>');
                    }
                    else {
                        $('.swiper-svideo .swiper-wrapper').append('<div class="swiper-slide">' + myHTML.itemHTML(opt,1,1) + '</div>');
                    }
                }
                ...
                for(var i=0;i<20&&i<res.playback.length;i++){
                    ...
                    if(i<5){
                        $('.swiper-playback .swiper-wrapper').append('<div class="swiper-slide">' + myHTML.itemHTML(opt,1) + '</div>');
                    }
                    else{
                        $('.swiper-playback .swiper-wrapper').append('<div class="swiper-slide">' + myHTML.itemHTML(opt,1,1) + '</div>');
                    }
                }
